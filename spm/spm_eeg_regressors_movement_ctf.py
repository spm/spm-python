...
def spm_eeg_regressors_movement_ctf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_regressors_movement_ctf.m)
  """

  return _Runtime.call("spm_eeg_regressors_movement_ctf", *args, **kwargs)
