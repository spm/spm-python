...
def spm_dirichlet_exceedance(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_dirichlet_exceedance.m)
  """

  return _Runtime.call("spm_dirichlet_exceedance", *args, **kwargs)
