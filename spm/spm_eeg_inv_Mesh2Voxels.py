...
def spm_eeg_inv_Mesh2Voxels(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_inv_Mesh2Voxels.m)
  """

  return _Runtime.call("spm_eeg_inv_Mesh2Voxels", *args, **kwargs)
