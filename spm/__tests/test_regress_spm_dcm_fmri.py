...
def test_regress_spm_dcm_fmri(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/tests/test_regress_spm_dcm_fmri.m)
  """

  return _Runtime.call("test_regress_spm_dcm_fmri", *args, **kwargs)
