...
def spm_dcm_post_hoc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_dcm_post_hoc.m)
  """

  return _Runtime.call("spm_dcm_post_hoc", *args, **kwargs)
