...
def spm_eeg_specest_hilbert(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_specest_hilbert.m)
  """

  return _Runtime.call("spm_eeg_specest_hilbert", *args, **kwargs)
