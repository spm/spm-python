...
def spm_invFcdf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_invFcdf.m)
  """

  return _Runtime.call("spm_invFcdf", *args, **kwargs)
