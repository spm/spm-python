...
def spm_eeg_inv_transform_mesh(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_inv_transform_mesh.m)
  """

  return _Runtime.call("spm_eeg_inv_transform_mesh", *args, **kwargs)
