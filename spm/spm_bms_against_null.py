...
def spm_bms_against_null(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_bms_against_null.m)
  """

  return _Runtime.call("spm_bms_against_null", *args, **kwargs, nargout=0)
