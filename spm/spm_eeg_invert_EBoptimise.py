...
def spm_eeg_invert_EBoptimise(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_invert_EBoptimise.m)
  """

  return _Runtime.call("spm_eeg_invert_EBoptimise", *args, **kwargs)
