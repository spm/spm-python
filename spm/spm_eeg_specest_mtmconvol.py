...
def spm_eeg_specest_mtmconvol(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_specest_mtmconvol.m)
  """

  return _Runtime.call("spm_eeg_specest_mtmconvol", *args, **kwargs)
