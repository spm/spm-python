...
def spm_eeg_artefact_saccade(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_artefact_saccade.m)
  """

  return _Runtime.call("spm_eeg_artefact_saccade", *args, **kwargs)
