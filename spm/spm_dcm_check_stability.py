...
def spm_dcm_check_stability(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_dcm_check_stability.m)
  """

  return _Runtime.call("spm_dcm_check_stability", *args, **kwargs)
