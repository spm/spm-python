...
def _warp_dykstra2012(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/warp_dykstra2012.m)
  """

  return _Runtime.call("warp_dykstra2012", *args, **kwargs)
