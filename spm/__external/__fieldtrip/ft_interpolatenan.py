...
def ft_interpolatenan(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_interpolatenan.m)
  """

  return _Runtime.call("ft_interpolatenan", *args, **kwargs)
