...
def ft_dipolesimulation(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_dipolesimulation.m)
  """

  return _Runtime.call("ft_dipolesimulation", *args, **kwargs)
