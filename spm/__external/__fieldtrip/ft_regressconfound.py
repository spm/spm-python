...
def ft_regressconfound(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_regressconfound.m)
  """

  return _Runtime.call("ft_regressconfound", *args, **kwargs)
