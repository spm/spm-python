...
def ft_plot_line(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/ft_plot_line.m)
  """

  return _Runtime.call("ft_plot_line", *args, **kwargs)
