...
def _triangle2connectivity(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/triangle2connectivity.m)
  """

  return _Runtime.call("triangle2connectivity", *args, **kwargs)
