...
def _atlas_lookup(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/atlas_lookup.m)
  """

  return _Runtime.call("atlas_lookup", *args, **kwargs)
