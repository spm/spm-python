...
def _brain(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/brain.m)
  """

  return _Runtime.call("brain", *args, **kwargs)
