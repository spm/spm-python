...
def _surface_orientation(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/surface_orientation.m)
  """

  return _Runtime.call("surface_orientation", *args, **kwargs)
