...
def _skin_medium_dark(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/skin_medium_dark.m)
  """

  return _Runtime.call("skin_medium_dark", *args, **kwargs)
