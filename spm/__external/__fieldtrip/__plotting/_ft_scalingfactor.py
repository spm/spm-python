...
def _ft_scalingfactor(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/ft_scalingfactor.m)
  """

  return _Runtime.call("ft_scalingfactor", *args, **kwargs)
