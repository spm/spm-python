...
def _findcluster(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/findcluster.m)
  """

  return _Runtime.call("findcluster", *args, **kwargs)
