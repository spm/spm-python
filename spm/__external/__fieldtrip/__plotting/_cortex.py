...
def _cortex(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/cortex.m)
  """

  return _Runtime.call("cortex", *args, **kwargs)
