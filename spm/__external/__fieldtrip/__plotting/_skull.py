...
def _skull(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/skull.m)
  """

  return _Runtime.call("skull", *args, **kwargs)
