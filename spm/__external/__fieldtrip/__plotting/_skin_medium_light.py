...
def _skin_medium_light(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/skin_medium_light.m)
  """

  return _Runtime.call("skin_medium_light", *args, **kwargs)
