...
def ft_plot_headmodel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/ft_plot_headmodel.m)
  """

  return _Runtime.call("ft_plot_headmodel", *args, **kwargs, nargout=0)
