...
def ft_select_channel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/ft_select_channel.m)
  """

  return _Runtime.call("ft_select_channel", *args, **kwargs, nargout=0)
