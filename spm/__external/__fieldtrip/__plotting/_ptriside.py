...
def _ptriside(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/plotting/private/ptriside.m)
  """

  return _Runtime.call("ptriside", *args, **kwargs)
