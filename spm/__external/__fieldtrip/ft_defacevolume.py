...
def ft_defacevolume(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_defacevolume.m)
  """

  return _Runtime.call("ft_defacevolume", *args, **kwargs)
