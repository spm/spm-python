...
def ft_componentanalysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_componentanalysis.m)
  """

  return _Runtime.call("ft_componentanalysis", *args, **kwargs)
