...
def ft_mvaranalysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_mvaranalysis.m)
  """

  return _Runtime.call("ft_mvaranalysis", *args, **kwargs)
