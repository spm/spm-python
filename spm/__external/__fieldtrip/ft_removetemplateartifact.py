...
def ft_removetemplateartifact(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_removetemplateartifact.m)
  """

  return _Runtime.call("ft_removetemplateartifact", *args, **kwargs)
