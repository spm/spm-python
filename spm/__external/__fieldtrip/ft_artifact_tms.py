...
def ft_artifact_tms(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_artifact_tms.m)
  """

  return _Runtime.call("ft_artifact_tms", *args, **kwargs)
