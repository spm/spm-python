...
def ft_timelockstatistics(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_timelockstatistics.m)
  """

  return _Runtime.call("ft_timelockstatistics", *args, **kwargs)
