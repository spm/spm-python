...
def ft_timelocksimulation(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_timelocksimulation.m)
  """

  return _Runtime.call("ft_timelocksimulation", *args, **kwargs)
