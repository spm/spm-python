...
def ft_preproc_padding(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/preproc/ft_preproc_padding.m)
  """

  return _Runtime.call("ft_preproc_padding", *args, **kwargs)
