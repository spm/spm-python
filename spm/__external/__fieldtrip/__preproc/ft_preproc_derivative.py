...
def ft_preproc_derivative(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/preproc/ft_preproc_derivative.m)
  """

  return _Runtime.call("ft_preproc_derivative", *args, **kwargs)
