...
def ft_sourcewrite(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_sourcewrite.m)
  """

  return _Runtime.call("ft_sourcewrite", *args, **kwargs, nargout=0)
