...
def _triangle2distance(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/triangle2distance.m)
  """

  return _Runtime.call("triangle2distance", *args, **kwargs)
