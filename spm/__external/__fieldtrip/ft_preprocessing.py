...
def ft_preprocessing(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_preprocessing.m)
  """

  return _Runtime.call("ft_preprocessing", *args, **kwargs)
