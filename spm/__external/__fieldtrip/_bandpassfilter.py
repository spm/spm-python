...
def _bandpassfilter(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/bandpassfilter.m)
  """

  return _Runtime.call("bandpassfilter", *args, **kwargs)
