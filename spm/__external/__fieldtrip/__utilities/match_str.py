...
def match_str(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/match_str.m)
  """

  return _Runtime.call("match_str", *args, **kwargs)
