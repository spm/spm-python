...
def _globalrescale(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/globalrescale.m)
  """

  return _Runtime.call("globalrescale", *args, **kwargs)
