...
def _unparcellate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/unparcellate.m)
  """

  return _Runtime.call("unparcellate", *args, **kwargs)
