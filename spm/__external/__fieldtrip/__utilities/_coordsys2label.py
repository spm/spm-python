...
def _coordsys2label(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/coordsys2label.m)
  """

  return _Runtime.call("coordsys2label", *args, **kwargs)
