...
def _quaternion(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/quaternion.m)
  """

  return _Runtime.call("quaternion", *args, **kwargs)
