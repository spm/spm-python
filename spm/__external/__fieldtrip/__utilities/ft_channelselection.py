...
def ft_channelselection(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_channelselection.m)
  """

  return _Runtime.call("ft_channelselection", *args, **kwargs)
