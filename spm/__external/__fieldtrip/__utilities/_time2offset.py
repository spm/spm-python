...
def _time2offset(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/time2offset.m)
  """

  return _Runtime.call("time2offset", *args, **kwargs)
