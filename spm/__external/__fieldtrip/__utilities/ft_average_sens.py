...
def ft_average_sens(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_average_sens.m)
  """

  return _Runtime.call("ft_average_sens", *args, **kwargs)
