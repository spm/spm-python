...
def ft_standalone(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_standalone.m)
  """

  return _Runtime.call("ft_standalone", *args, **kwargs, nargout=0)
