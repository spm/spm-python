...
def _project_elec(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/project_elec.m)
  """

  return _Runtime.call("project_elec", *args, **kwargs)
