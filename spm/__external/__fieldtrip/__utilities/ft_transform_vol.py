...
def ft_transform_vol(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_transform_vol.m)
  """

  return _Runtime.call("ft_transform_vol", *args, **kwargs)
