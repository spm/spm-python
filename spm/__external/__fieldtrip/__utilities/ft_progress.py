...
def ft_progress(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_progress.m)
  """

  return _Runtime.call("ft_progress", *args, **kwargs, nargout=0)
