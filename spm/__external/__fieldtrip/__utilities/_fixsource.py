...
def _fixsource(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/fixsource.m)
  """

  return _Runtime.call("fixsource", *args, **kwargs)
