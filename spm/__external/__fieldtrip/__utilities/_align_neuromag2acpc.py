...
def _align_neuromag2acpc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/align_neuromag2acpc.m)
  """

  return _Runtime.call("align_neuromag2acpc", *args, **kwargs)
