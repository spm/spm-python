...
def ft_compile_mex(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_compile_mex.m)
  """

  return _Runtime.call("ft_compile_mex", *args, **kwargs, nargout=0)
