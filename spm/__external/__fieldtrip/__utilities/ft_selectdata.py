...
def ft_selectdata(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_selectdata.m)
  """

  return _Runtime.call("ft_selectdata", *args, **kwargs)
