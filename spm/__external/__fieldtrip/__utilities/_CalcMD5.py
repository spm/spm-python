...
def _CalcMD5(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/CalcMD5.m)
  """

  return _Runtime.call("CalcMD5", *args, **kwargs)
