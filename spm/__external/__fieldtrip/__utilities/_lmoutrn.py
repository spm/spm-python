...
def _lmoutrn(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/private/lmoutrn.m)
  """

  return _Runtime.call("lmoutrn", *args, **kwargs)
