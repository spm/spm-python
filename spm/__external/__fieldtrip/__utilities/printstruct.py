...
def printstruct(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/printstruct.m)
  """

  return _Runtime.call("printstruct", *args, **kwargs)
