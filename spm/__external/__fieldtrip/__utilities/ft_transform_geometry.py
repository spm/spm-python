...
def ft_transform_geometry(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/utilities/ft_transform_geometry.m)
  """

  return _Runtime.call("ft_transform_geometry", *args, **kwargs)
