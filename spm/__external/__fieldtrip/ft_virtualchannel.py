...
def ft_virtualchannel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_virtualchannel.m)
  """

  return _Runtime.call("ft_virtualchannel", *args, **kwargs)
