...
def ft_connectivityplot(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_connectivityplot.m)
  """

  return _Runtime.call("ft_connectivityplot", *args, **kwargs)
