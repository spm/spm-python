...
def ft_crossfrequencyanalysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_crossfrequencyanalysis.m)
  """

  return _Runtime.call("ft_crossfrequencyanalysis", *args, **kwargs)
