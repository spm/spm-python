...
def ft_headmodel_interpolate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/ft_headmodel_interpolate.m)
  """

  return _Runtime.call("ft_headmodel_interpolate", *args, **kwargs)
