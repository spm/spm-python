...
def ft_senslabel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/ft_senslabel.m)
  """

  return _Runtime.call("ft_senslabel", *args, **kwargs)
