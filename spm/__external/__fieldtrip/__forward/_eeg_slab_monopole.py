...
def _eeg_slab_monopole(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/eeg_slab_monopole.m)
  """

  return _Runtime.call("eeg_slab_monopole", *args, **kwargs)
