...
def _hasyokogawa(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/hasyokogawa.m)
  """

  return _Runtime.call("hasyokogawa", *args, **kwargs)
