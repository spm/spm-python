...
def _find_triangle_neighbours(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/find_triangle_neighbours.m)
  """

  return _Runtime.call("find_triangle_neighbours", *args, **kwargs)
