...
def ft_apply_montage(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/ft_apply_montage.m)
  """

  return _Runtime.call("ft_apply_montage", *args, **kwargs)
