...
def ft_convert_units(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/ft_convert_units.m)
  """

  return _Runtime.call("ft_convert_units", *args, **kwargs)
