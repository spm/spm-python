...
def _eeg_infinite_monopole(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/eeg_infinite_monopole.m)
  """

  return _Runtime.call("eeg_infinite_monopole", *args, **kwargs)
