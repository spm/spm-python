...
def _leadfield_duneuro(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/leadfield_duneuro.m)
  """

  return _Runtime.call("leadfield_duneuro", *args, **kwargs)
