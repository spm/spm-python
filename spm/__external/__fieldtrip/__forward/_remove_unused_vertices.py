...
def _remove_unused_vertices(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/remove_unused_vertices.m)
  """

  return _Runtime.call("remove_unused_vertices", *args, **kwargs)
