...
def _ft_headcoordinates(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/forward/private/ft_headcoordinates.m)
  """

  return _Runtime.call("ft_headcoordinates", *args, **kwargs)
