...
def ft_statistics_crossvalidate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_statistics_crossvalidate.m)
  """

  return _Runtime.call("ft_statistics_crossvalidate", *args, **kwargs)
