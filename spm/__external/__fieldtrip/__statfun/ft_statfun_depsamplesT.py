...
def ft_statfun_depsamplesT(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/statfun/ft_statfun_depsamplesT.m)
  """

  return _Runtime.call("ft_statfun_depsamplesT", *args, **kwargs)
