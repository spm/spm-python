...
def ft_scalpcurrentdensity(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_scalpcurrentdensity.m)
  """

  return _Runtime.call("ft_scalpcurrentdensity", *args, **kwargs)
