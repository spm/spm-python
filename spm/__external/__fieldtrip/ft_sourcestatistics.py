...
def ft_sourcestatistics(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_sourcestatistics.m)
  """

  return _Runtime.call("ft_sourcestatistics", *args, **kwargs)
