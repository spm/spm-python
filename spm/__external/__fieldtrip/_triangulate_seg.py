...
def _triangulate_seg(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/triangulate_seg.m)
  """

  return _Runtime.call("triangulate_seg", *args, **kwargs)
