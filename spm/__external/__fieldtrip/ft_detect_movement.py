...
def ft_detect_movement(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_detect_movement.m)
  """

  return _Runtime.call("ft_detect_movement", *args, **kwargs)
