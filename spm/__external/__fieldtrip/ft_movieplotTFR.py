...
def ft_movieplotTFR(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_movieplotTFR.m)
  """

  return _Runtime.call("ft_movieplotTFR", *args, **kwargs)
