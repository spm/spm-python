...
def ft_combineplanar(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_combineplanar.m)
  """

  return _Runtime.call("ft_combineplanar", *args, **kwargs)
