...
def _ft_getuserfun(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/ft_getuserfun.m)
  """

  return _Runtime.call("ft_getuserfun", *args, **kwargs)
