...
def ft_connectivityanalysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_connectivityanalysis.m)
  """

  return _Runtime.call("ft_connectivityanalysis", *args, **kwargs)
