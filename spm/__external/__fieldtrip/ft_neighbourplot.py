...
def ft_neighbourplot(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_neighbourplot.m)
  """

  return _Runtime.call("ft_neighbourplot", *args, **kwargs)
