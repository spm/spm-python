...
def _artifact2trl(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/artifact2trl.m)
  """

  return _Runtime.call("artifact2trl", *args, **kwargs)
