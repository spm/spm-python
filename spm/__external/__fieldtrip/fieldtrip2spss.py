...
def fieldtrip2spss(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fieldtrip2spss.m)
  """

  return _Runtime.call("fieldtrip2spss", *args, **kwargs, nargout=0)
