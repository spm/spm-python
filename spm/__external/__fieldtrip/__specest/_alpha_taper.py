...
def _alpha_taper(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/specest/private/alpha_taper.m)
  """

  return _Runtime.call("alpha_taper", *args, **kwargs)
