...
def ft_geometryplot(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_geometryplot.m)
  """

  return _Runtime.call("ft_geometryplot", *args, **kwargs)
