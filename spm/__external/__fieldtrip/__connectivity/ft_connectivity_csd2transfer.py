...
def ft_connectivity_csd2transfer(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/ft_connectivity_csd2transfer.m)
  """

  return _Runtime.call("ft_connectivity_csd2transfer", *args, **kwargs)
