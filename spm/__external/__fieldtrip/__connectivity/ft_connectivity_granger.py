...
def ft_connectivity_granger(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/ft_connectivity_granger.m)
  """

  return _Runtime.call("ft_connectivity_granger", *args, **kwargs)
