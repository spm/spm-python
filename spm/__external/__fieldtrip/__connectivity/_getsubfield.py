...
def _getsubfield(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/private/getsubfield.m)
  """

  return _Runtime.call("getsubfield", *args, **kwargs)
