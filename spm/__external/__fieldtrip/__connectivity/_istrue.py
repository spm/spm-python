...
def _istrue(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/private/istrue.m)
  """

  return _Runtime.call("istrue", *args, **kwargs)
