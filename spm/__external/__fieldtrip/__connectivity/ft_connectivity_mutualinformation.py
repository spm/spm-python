...
def ft_connectivity_mutualinformation(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/ft_connectivity_mutualinformation.m)
  """

  return _Runtime.call("ft_connectivity_mutualinformation", *args, **kwargs)
