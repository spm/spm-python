...
def ft_connectivity_dtf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/connectivity/ft_connectivity_dtf.m)
  """

  return _Runtime.call("ft_connectivity_dtf", *args, **kwargs)
