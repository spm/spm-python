...
def ft_prepare_neighbours(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_prepare_neighbours.m)
  """

  return _Runtime.call("ft_prepare_neighbours", *args, **kwargs)
