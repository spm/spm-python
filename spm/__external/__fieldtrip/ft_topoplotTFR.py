...
def ft_topoplotTFR(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_topoplotTFR.m)
  """

  return _Runtime.call("ft_topoplotTFR", *args, **kwargs)
