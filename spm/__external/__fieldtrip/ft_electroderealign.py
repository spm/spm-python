...
def ft_electroderealign(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_electroderealign.m)
  """

  return _Runtime.call("ft_electroderealign", *args, **kwargs)
