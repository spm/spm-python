...
def ft_resampledata(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_resampledata.m)
  """

  return _Runtime.call("ft_resampledata", *args, **kwargs)
