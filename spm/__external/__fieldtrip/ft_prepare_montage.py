...
def ft_prepare_montage(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_prepare_montage.m)
  """

  return _Runtime.call("ft_prepare_montage", *args, **kwargs)
