...
def _event2boolvec(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/event2boolvec.m)
  """

  return _Runtime.call("event2boolvec", *args, **kwargs)
