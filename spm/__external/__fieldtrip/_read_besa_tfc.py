...
def _read_besa_tfc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/read_besa_tfc.m)
  """

  return _Runtime.call("read_besa_tfc", *args, **kwargs)
