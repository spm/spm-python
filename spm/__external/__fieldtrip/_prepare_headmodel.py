...
def _prepare_headmodel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/prepare_headmodel.m)
  """

  return _Runtime.call("prepare_headmodel", *args, **kwargs)
