...
def _randstatprob(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/randstatprob.m)
  """

  return _Runtime.call("randstatprob", *args, **kwargs)
