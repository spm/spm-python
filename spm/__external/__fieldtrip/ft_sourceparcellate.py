...
def ft_sourceparcellate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_sourceparcellate.m)
  """

  return _Runtime.call("ft_sourceparcellate", *args, **kwargs)
