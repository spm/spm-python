...
def _interp_gridded(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/interp_gridded.m)
  """

  return _Runtime.call("interp_gridded", *args, **kwargs)
