...
def ft_rejectcomponent(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_rejectcomponent.m)
  """

  return _Runtime.call("ft_rejectcomponent", *args, **kwargs)
