...
def ft_freqstatistics(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_freqstatistics.m)
  """

  return _Runtime.call("ft_freqstatistics", *args, **kwargs)
