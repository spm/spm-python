...
def ft_respiration(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_respiration.m)
  """

  return _Runtime.call("ft_respiration", *args, **kwargs)
