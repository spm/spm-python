...
def ft_statistics_analytic(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_statistics_analytic.m)
  """

  return _Runtime.call("ft_statistics_analytic", *args, **kwargs)
