...
def ft_denoise_synthetic(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_denoise_synthetic.m)
  """

  return _Runtime.call("ft_denoise_synthetic", *args, **kwargs)
