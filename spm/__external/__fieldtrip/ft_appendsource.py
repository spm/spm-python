...
def ft_appendsource(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_appendsource.m)
  """

  return _Runtime.call("ft_appendsource", *args, **kwargs)
