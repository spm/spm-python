...
def ft_timelockbaseline(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_timelockbaseline.m)
  """

  return _Runtime.call("ft_timelockbaseline", *args, **kwargs)
