...
def ft_write_data(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_write_data.m)
  """

  return _Runtime.call("ft_write_data", *args, **kwargs, nargout=0)
