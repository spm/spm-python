...
def _read_brainstorm_data(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_brainstorm_data.m)
  """

  return _Runtime.call("read_brainstorm_data", *args, **kwargs)
