...
def _qualisys_tsv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/qualisys_tsv.m)
  """

  return _Runtime.call("qualisys_tsv", *args, **kwargs)
