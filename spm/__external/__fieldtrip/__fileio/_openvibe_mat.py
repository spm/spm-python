...
def _openvibe_mat(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/openvibe_mat.m)
  """

  return _Runtime.call("openvibe_mat", *args, **kwargs)
