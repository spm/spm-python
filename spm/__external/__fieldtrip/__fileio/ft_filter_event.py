...
def ft_filter_event(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_filter_event.m)
  """

  return _Runtime.call("ft_filter_event", *args, **kwargs)
