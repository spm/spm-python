...
def _read_yokogawa_header_new(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_yokogawa_header_new.m)
  """

  return _Runtime.call("read_yokogawa_header_new", *args, **kwargs)
