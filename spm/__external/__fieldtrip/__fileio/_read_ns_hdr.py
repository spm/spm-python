...
def _read_ns_hdr(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ns_hdr.m)
  """

  return _Runtime.call("read_ns_hdr", *args, **kwargs)
