...
def _read_mayo_mef21(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_mayo_mef21.m)
  """

  return _Runtime.call("read_mayo_mef21", *args, **kwargs)
