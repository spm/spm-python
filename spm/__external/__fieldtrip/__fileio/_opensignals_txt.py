...
def _opensignals_txt(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/opensignals_txt.m)
  """

  return _Runtime.call("opensignals_txt", *args, **kwargs)
