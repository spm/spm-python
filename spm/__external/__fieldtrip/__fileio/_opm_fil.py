...
def _opm_fil(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/opm_fil.m)
  """

  return _Runtime.call("opm_fil", *args, **kwargs)
