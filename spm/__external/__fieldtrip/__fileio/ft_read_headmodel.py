...
def ft_read_headmodel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_read_headmodel.m)
  """

  return _Runtime.call("ft_read_headmodel", *args, **kwargs)
