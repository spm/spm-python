...
def _read_ctf_ascii(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ctf_ascii.m)
  """

  return _Runtime.call("read_ctf_ascii", *args, **kwargs)
