...
def _read_edf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_edf.m)
  """

  return _Runtime.call("read_edf", *args, **kwargs)
