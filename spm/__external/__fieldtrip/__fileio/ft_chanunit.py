...
def ft_chanunit(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_chanunit.m)
  """

  return _Runtime.call("ft_chanunit", *args, **kwargs)
