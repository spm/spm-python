...
def _read_biosemi_bdf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_biosemi_bdf.m)
  """

  return _Runtime.call("read_biosemi_bdf", *args, **kwargs)
