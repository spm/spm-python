...
def _read_curry(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_curry.m)
  """

  return _Runtime.call("read_curry", *args, **kwargs)
