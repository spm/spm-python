...
def _read_nmc_archive_k_data(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_nmc_archive_k_data.m)
  """

  return _Runtime.call("read_nmc_archive_k_data", *args, **kwargs)
