...
def _read_egis_data(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_egis_data.m)
  """

  return _Runtime.call("read_egis_data", *args, **kwargs)
