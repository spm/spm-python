...
def _motion_c3d(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/motion_c3d.m)
  """

  return _Runtime.call("motion_c3d", *args, **kwargs)
