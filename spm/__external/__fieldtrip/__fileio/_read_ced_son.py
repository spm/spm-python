...
def _read_ced_son(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ced_son.m)
  """

  return _Runtime.call("read_ced_son", *args, **kwargs)
