...
def _read_yokogawa_header(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_yokogawa_header.m)
  """

  return _Runtime.call("read_yokogawa_header", *args, **kwargs)
