...
def _read_neuromag_hc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_neuromag_hc.m)
  """

  return _Runtime.call("read_neuromag_hc", *args, **kwargs)
