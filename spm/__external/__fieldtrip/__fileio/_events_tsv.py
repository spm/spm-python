...
def _events_tsv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/events_tsv.m)
  """

  return _Runtime.call("events_tsv", *args, **kwargs)
