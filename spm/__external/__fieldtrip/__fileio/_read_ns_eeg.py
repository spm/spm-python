...
def _read_ns_eeg(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ns_eeg.m)
  """

  return _Runtime.call("read_ns_eeg", *args, **kwargs)
