...
def _read_bucn_nirshdr(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_bucn_nirshdr.m)
  """

  return _Runtime.call("read_bucn_nirshdr", *args, **kwargs)
