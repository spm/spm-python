...
def _read_plexon_nex(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_plexon_nex.m)
  """

  return _Runtime.call("read_plexon_nex", *args, **kwargs)
