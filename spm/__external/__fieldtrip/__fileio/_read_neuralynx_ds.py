...
def _read_neuralynx_ds(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_neuralynx_ds.m)
  """

  return _Runtime.call("read_neuralynx_ds", *args, **kwargs)
