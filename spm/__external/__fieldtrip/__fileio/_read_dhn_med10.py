...
def _read_dhn_med10(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_dhn_med10.m)
  """

  return _Runtime.call("read_dhn_med10", *args, **kwargs)
