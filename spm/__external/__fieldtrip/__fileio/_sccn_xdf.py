...
def _sccn_xdf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/sccn_xdf.m)
  """

  return _Runtime.call("sccn_xdf", *args, **kwargs)
