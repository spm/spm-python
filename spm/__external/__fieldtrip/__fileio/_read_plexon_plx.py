...
def _read_plexon_plx(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_plexon_plx.m)
  """

  return _Runtime.call("read_plexon_plx", *args, **kwargs)
