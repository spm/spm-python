...
def ft_read_sens(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_read_sens.m)
  """

  return _Runtime.call("ft_read_sens", *args, **kwargs)
