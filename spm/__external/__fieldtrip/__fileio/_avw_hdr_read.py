...
def _avw_hdr_read(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/avw_hdr_read.m)
  """

  return _Runtime.call("avw_hdr_read", *args, **kwargs)
