...
def _read_neuralynx_dma(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_neuralynx_dma.m)
  """

  return _Runtime.call("read_neuralynx_dma", *args, **kwargs)
