...
def ft_chantype(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_chantype.m)
  """

  return _Runtime.call("ft_chantype", *args, **kwargs)
