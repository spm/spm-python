...
def _hasricoh(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/hasricoh.m)
  """

  return _Runtime.call("hasricoh", *args, **kwargs)
