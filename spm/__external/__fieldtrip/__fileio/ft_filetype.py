...
def ft_filetype(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_filetype.m)
  """

  return _Runtime.call("ft_filetype", *args, **kwargs)
