...
def _sensys_csv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/sensys_csv.m)
  """

  return _Runtime.call("sensys_csv", *args, **kwargs)
