...
def _read_bucn_nirsdata(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_bucn_nirsdata.m)
  """

  return _Runtime.call("read_bucn_nirsdata", *args, **kwargs)
