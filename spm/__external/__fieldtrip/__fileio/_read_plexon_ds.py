...
def _read_plexon_ds(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_plexon_ds.m)
  """

  return _Runtime.call("read_plexon_ds", *args, **kwargs)
