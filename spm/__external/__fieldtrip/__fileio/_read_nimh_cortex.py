...
def _read_nimh_cortex(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_nimh_cortex.m)
  """

  return _Runtime.call("read_nimh_cortex", *args, **kwargs)
