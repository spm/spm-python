...
def _xsens_mvnx(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/xsens_mvnx.m)
  """

  return _Runtime.call("xsens_mvnx", *args, **kwargs)
