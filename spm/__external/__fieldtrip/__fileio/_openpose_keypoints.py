...
def _openpose_keypoints(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/openpose_keypoints.m)
  """

  return _Runtime.call("openpose_keypoints", *args, **kwargs)
