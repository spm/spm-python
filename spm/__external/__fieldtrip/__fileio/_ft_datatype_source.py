...
def _ft_datatype_source(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/ft_datatype_source.m)
  """

  return _Runtime.call("ft_datatype_source", *args, **kwargs)
