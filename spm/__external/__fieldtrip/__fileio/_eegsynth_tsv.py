...
def _eegsynth_tsv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/eegsynth_tsv.m)
  """

  return _Runtime.call("eegsynth_tsv", *args, **kwargs)
