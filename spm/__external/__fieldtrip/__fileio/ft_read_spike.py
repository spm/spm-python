...
def ft_read_spike(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_read_spike.m)
  """

  return _Runtime.call("ft_read_spike", *args, **kwargs)
