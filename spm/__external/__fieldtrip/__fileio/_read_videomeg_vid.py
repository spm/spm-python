...
def _read_videomeg_vid(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_videomeg_vid.m)
  """

  return _Runtime.call("read_videomeg_vid", *args, **kwargs)
