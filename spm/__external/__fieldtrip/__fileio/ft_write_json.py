...
def ft_write_json(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/ft_write_json.m)
  """

  return _Runtime.call("ft_write_json", *args, **kwargs, nargout=0)
