...
def _read_nervus_header(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_nervus_header.m)
  """

  return _Runtime.call("read_nervus_header", *args, **kwargs)
