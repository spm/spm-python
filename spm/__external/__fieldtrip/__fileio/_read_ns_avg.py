...
def _read_ns_avg(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ns_avg.m)
  """

  return _Runtime.call("read_ns_avg", *args, **kwargs)
