...
def _np_readfileinfo(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/np_readfileinfo.m)
  """

  return _Runtime.call("np_readfileinfo", *args, **kwargs)
