...
def _read_ctf_coef(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/read_ctf_coef.m)
  """

  return _Runtime.call("read_ctf_coef", *args, **kwargs)
