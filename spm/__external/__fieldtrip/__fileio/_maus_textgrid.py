...
def _maus_textgrid(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/fileio/private/maus_textgrid.m)
  """

  return _Runtime.call("maus_textgrid", *args, **kwargs)
