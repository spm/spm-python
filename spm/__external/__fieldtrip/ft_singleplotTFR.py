...
def ft_singleplotTFR(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_singleplotTFR.m)
  """

  return _Runtime.call("ft_singleplotTFR", *args, **kwargs)
