...
def ft_singleplotER(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_singleplotER.m)
  """

  return _Runtime.call("ft_singleplotER", *args, **kwargs)
