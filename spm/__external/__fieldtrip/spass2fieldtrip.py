...
def spass2fieldtrip(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/spass2fieldtrip.m)
  """

  return _Runtime.call("spass2fieldtrip", *args, **kwargs)
