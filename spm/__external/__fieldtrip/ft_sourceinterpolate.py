...
def ft_sourceinterpolate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_sourceinterpolate.m)
  """

  return _Runtime.call("ft_sourceinterpolate", *args, **kwargs)
