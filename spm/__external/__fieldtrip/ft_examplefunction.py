...
def ft_examplefunction(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_examplefunction.m)
  """

  return _Runtime.call("ft_examplefunction", *args, **kwargs)
