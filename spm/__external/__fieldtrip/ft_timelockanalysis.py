...
def ft_timelockanalysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_timelockanalysis.m)
  """

  return _Runtime.call("ft_timelockanalysis", *args, **kwargs)
