...
def ft_trialfun_imotions(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/trialfun/ft_trialfun_imotions.m)
  """

  return _Runtime.call("ft_trialfun_imotions", *args, **kwargs)
