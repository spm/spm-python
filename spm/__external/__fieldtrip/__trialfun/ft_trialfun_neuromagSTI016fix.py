...
def ft_trialfun_neuromagSTI016fix(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/trialfun/ft_trialfun_neuromagSTI016fix.m)
  """

  return _Runtime.call("ft_trialfun_neuromagSTI016fix", *args, **kwargs)
