...
def hanning(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/external/signal/hanning.m)
  """

  return _Runtime.call("hanning", *args, **kwargs)
