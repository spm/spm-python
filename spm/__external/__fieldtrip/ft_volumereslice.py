...
def ft_volumereslice(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_volumereslice.m)
  """

  return _Runtime.call("ft_volumereslice", *args, **kwargs)
