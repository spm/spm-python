...
def ft_prepare_sourcemodel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_prepare_sourcemodel.m)
  """

  return _Runtime.call("ft_prepare_sourcemodel", *args, **kwargs)
