...
def ft_sourcedescriptives(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_sourcedescriptives.m)
  """

  return _Runtime.call("ft_sourcedescriptives", *args, **kwargs)
