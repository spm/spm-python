...
def ft_artifact_muscle(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_artifact_muscle.m)
  """

  return _Runtime.call("ft_artifact_muscle", *args, **kwargs)
