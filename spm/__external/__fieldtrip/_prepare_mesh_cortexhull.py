...
def _prepare_mesh_cortexhull(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/prepare_mesh_cortexhull.m)
  """

  return _Runtime.call("prepare_mesh_cortexhull", *args, **kwargs)
