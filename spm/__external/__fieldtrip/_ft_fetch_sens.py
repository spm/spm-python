...
def _ft_fetch_sens(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/ft_fetch_sens.m)
  """

  return _Runtime.call("ft_fetch_sens", *args, **kwargs)
