...
def _prepare_design(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/prepare_design.m)
  """

  return _Runtime.call("prepare_design", *args, **kwargs)
