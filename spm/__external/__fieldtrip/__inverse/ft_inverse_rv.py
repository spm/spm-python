...
def ft_inverse_rv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/ft_inverse_rv.m)
  """

  return _Runtime.call("ft_inverse_rv", *args, **kwargs)
