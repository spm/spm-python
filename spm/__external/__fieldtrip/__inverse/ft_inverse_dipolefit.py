...
def ft_inverse_dipolefit(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/ft_inverse_dipolefit.m)
  """

  return _Runtime.call("ft_inverse_dipolefit", *args, **kwargs)
