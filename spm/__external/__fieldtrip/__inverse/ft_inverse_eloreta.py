...
def ft_inverse_eloreta(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/ft_inverse_eloreta.m)
  """

  return _Runtime.call("ft_inverse_eloreta", *args, **kwargs)
