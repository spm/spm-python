...
def _find_innermost_boundary(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/private/find_innermost_boundary.m)
  """

  return _Runtime.call("find_innermost_boundary", *args, **kwargs)
