...
def _mesh_laplacian(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/private/mesh_laplacian.m)
  """

  return _Runtime.call("mesh_laplacian", *args, **kwargs)
