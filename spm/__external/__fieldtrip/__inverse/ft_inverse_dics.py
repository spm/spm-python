...
def ft_inverse_dics(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/inverse/ft_inverse_dics.m)
  """

  return _Runtime.call("ft_inverse_dics", *args, **kwargs)
