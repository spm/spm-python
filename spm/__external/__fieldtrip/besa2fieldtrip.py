...
def besa2fieldtrip(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/besa2fieldtrip.m)
  """

  return _Runtime.call("besa2fieldtrip", *args, **kwargs)
