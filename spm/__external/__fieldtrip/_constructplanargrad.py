...
def _constructplanargrad(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/constructplanargrad.m)
  """

  return _Runtime.call("constructplanargrad", *args, **kwargs)
