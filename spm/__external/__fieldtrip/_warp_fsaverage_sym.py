...
def _warp_fsaverage_sym(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/warp_fsaverage_sym.m)
  """

  return _Runtime.call("warp_fsaverage_sym", *args, **kwargs)
