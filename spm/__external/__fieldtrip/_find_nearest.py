...
def _find_nearest(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/find_nearest.m)
  """

  return _Runtime.call("find_nearest", *args, **kwargs)
