...
def ft_clusterplot(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_clusterplot.m)
  """

  return _Runtime.call("ft_clusterplot", *args, **kwargs)
