...
def _event2artifact(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/event2artifact.m)
  """

  return _Runtime.call("event2artifact", *args, **kwargs)
