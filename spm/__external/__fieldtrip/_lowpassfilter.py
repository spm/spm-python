...
def _lowpassfilter(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/private/lowpassfilter.m)
  """

  return _Runtime.call("lowpassfilter", *args, **kwargs)
