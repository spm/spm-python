...
def ft_steadystatesimulation(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_steadystatesimulation.m)
  """

  return _Runtime.call("ft_steadystatesimulation", *args, **kwargs)
