...
def ft_audiovideobrowser(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/fieldtrip/ft_audiovideobrowser.m)
  """

  return _Runtime.call("ft_audiovideobrowser", *args, **kwargs, nargout=0)
