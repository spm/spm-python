...
def bemcp_example(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/bemcp/bemcp_example.m)
  """

  return _Runtime.call("bemcp_example", *args, **kwargs, nargout=0)
