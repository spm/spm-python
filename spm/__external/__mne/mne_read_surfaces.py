...
def mne_read_surfaces(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/mne_read_surfaces.m)
  """

  return _Runtime.call("mne_read_surfaces", *args, **kwargs)
