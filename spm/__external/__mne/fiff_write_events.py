...
def fiff_write_events(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/fiff_write_events.m)
  """

  return _Runtime.call("fiff_write_events", *args, **kwargs, nargout=0)
