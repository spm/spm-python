...
def mne_source_spectral_analysis(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/mne_source_spectral_analysis.m)
  """

  return _Runtime.call("mne_source_spectral_analysis", *args, **kwargs)
