...
def mne_ex_read_epochs(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/mne_ex_read_epochs.m)
  """

  return _Runtime.call("mne_ex_read_epochs", *args, **kwargs)
