...
def fiff_read_coord_trans(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/fiff_read_coord_trans.m)
  """

  return _Runtime.call("fiff_read_coord_trans", *args, **kwargs)
