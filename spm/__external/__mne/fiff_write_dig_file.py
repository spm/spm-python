...
def fiff_write_dig_file(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/external/mne/fiff_write_dig_file.m)
  """

  return _Runtime.call("fiff_write_dig_file", *args, **kwargs, nargout=0)
