...
def spm_gx_hdm(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_gx_hdm.m)
  """

  return _Runtime.call("spm_gx_hdm", *args, **kwargs)
