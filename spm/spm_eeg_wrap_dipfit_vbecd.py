...
def spm_eeg_wrap_dipfit_vbecd(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_wrap_dipfit_vbecd.m)
  """

  return _Runtime.call("spm_eeg_wrap_dipfit_vbecd", *args, **kwargs)
