...
def spm_ness_hd(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_ness_hd.m)
  """

  return _Runtime.call("spm_ness_hd", *args, **kwargs)
