...
def spm_ovhelper_3Dreg(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_orthviews/spm_ovhelper_3Dreg.m)
  """

  return _Runtime.call("spm_ovhelper_3Dreg", *args, **kwargs, nargout=0)
