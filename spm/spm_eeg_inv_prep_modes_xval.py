...
def spm_eeg_inv_prep_modes_xval(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_inv_prep_modes_xval.m)
  """

  return _Runtime.call("spm_eeg_inv_prep_modes_xval", *args, **kwargs)
