...
def cfg_cfg_basicio_def(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/cfg_basicio/cfg_cfg_basicio_def.m)
  """

  return Runtime.call("cfg_cfg_basicio_def", *args, **kwargs)
