...
def cfg_run_subsrefvar(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/cfg_basicio/cfg_run_subsrefvar.m)
  """

  return _Runtime.call("cfg_run_subsrefvar", *args, **kwargs)
