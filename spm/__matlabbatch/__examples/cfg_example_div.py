...
def cfg_example_div(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/examples/cfg_example_div.m)
  """

  return _Runtime.call("cfg_example_div", *args, **kwargs)
