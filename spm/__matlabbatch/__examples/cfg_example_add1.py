...
def cfg_example_add1(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/examples/cfg_example_add1.m)
  """

  return _Runtime.call("cfg_example_add1", *args, **kwargs)
