...
def cfg_example_run_sum(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/examples/cfg_example_run_sum.m)
  """

  return _Runtime.call("cfg_example_run_sum", *args, **kwargs)
