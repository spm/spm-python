...
def toy_example(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/examples/toy_example.m)
  """

  return _Runtime.call("toy_example", *args, **kwargs, nargout=0)
