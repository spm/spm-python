...
def _cfg_maxextent(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/private/cfg_maxextent.m)
  """

  return _Runtime.call("cfg_maxextent", *args, **kwargs)
