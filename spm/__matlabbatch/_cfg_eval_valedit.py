...
def _cfg_eval_valedit(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/matlabbatch/private/cfg_eval_valedit.m)
  """

  return _Runtime.call("cfg_eval_valedit", *args, **kwargs)
