...
def spm_log_evidence_reduce(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_log_evidence_reduce.m)
  """

  return _Runtime.call("spm_log_evidence_reduce", *args, **kwargs)
