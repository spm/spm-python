...
def spm_eeg_artefact_peak2peak(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_artefact_peak2peak.m)
  """

  return _Runtime.call("spm_eeg_artefact_peak2peak", *args, **kwargs)
