...
def spm_fx_hdm(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_fx_hdm.m)
  """

  return _Runtime.call("spm_fx_hdm", *args, **kwargs)
