...
def spm_eeg_inv_mesh_spherify(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_inv_mesh_spherify.m)
  """

  return _Runtime.call("spm_eeg_inv_mesh_spherify", *args, **kwargs)
