...
def DEM_demo_MDP_fit_fields(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_MDP_fit_fields.m)
  """

  return _Runtime.call("DEM_demo_MDP_fit_fields", *args, **kwargs)
