...
def DEM_demo_ontology(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_ontology.m)
  """

  return _Runtime.call("DEM_demo_ontology", *args, **kwargs, nargout=0)
