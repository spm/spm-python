...
def DEM_COVID_UK(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_COVID_UK.m)
  """

  return _Runtime.call("DEM_COVID_UK", *args, **kwargs)
