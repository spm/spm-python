...
def spm_SARS_priors_B(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_SARS_priors_B.m)
  """

  return _Runtime.call("spm_SARS_priors_B", *args, **kwargs)
