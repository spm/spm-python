...
def spm_gx_dem_salience(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_gx_dem_salience.m)
  """

  return _Runtime.call("spm_gx_dem_salience", *args, **kwargs)
