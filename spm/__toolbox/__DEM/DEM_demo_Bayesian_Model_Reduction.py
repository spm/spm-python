...
def DEM_demo_Bayesian_Model_Reduction(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_Bayesian_Model_Reduction.m)
  """

  return _Runtime.call("DEM_demo_Bayesian_Model_Reduction", *args, **kwargs)
