...
def spm_MDP_log_evidence(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_MDP_log_evidence.m)
  """

  return _Runtime.call("spm_MDP_log_evidence", *args, **kwargs)
