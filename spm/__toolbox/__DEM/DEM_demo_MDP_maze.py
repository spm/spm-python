...
def DEM_demo_MDP_maze(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_MDP_maze.m)
  """

  return _Runtime.call("DEM_demo_MDP_maze", *args, **kwargs)
