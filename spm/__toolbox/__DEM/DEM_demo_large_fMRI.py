...
def DEM_demo_large_fMRI(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_large_fMRI.m)
  """

  return _Runtime.call("DEM_demo_large_fMRI", *args, **kwargs, nargout=0)
