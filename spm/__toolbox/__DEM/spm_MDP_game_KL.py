...
def spm_MDP_game_KL(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_MDP_game_KL.m)
  """

  return _Runtime.call("spm_MDP_game_KL", *args, **kwargs)
