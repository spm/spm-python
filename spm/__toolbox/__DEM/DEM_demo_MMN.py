...
def DEM_demo_MMN(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_MMN.m)
  """

  return _Runtime.call("DEM_demo_MMN", *args, **kwargs, nargout=0)
