...
def DEM_demo_doublewell_LAP(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_doublewell_LAP.m)
  """

  return _Runtime.call("DEM_demo_doublewell_LAP", *args, **kwargs, nargout=0)
