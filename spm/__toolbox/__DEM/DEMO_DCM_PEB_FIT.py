...
def DEMO_DCM_PEB_FIT(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEMO_DCM_PEB_FIT.m)
  """

  return _Runtime.call("DEMO_DCM_PEB_FIT", *args, **kwargs, nargout=0)
