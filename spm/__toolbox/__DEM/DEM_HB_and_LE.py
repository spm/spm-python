...
def DEM_HB_and_LE(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_HB_and_LE.m)
  """

  return _Runtime.call("DEM_HB_and_LE", *args, **kwargs, nargout=0)
