...
def spm_multinomial_log_evidence(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_multinomial_log_evidence.m)
  """

  return _Runtime.call("spm_multinomial_log_evidence", *args, **kwargs)
