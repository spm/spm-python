...
def spm_MDP_mountain_car(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_MDP_mountain_car.m)
  """

  return _Runtime.call("spm_MDP_mountain_car", *args, **kwargs, nargout=0)
