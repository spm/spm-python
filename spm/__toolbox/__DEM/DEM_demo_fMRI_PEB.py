...
def DEM_demo_fMRI_PEB(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_fMRI_PEB.m)
  """

  return _Runtime.call("DEM_demo_fMRI_PEB", *args, **kwargs, nargout=0)
