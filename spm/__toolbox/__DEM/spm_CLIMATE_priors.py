...
def spm_CLIMATE_priors(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_CLIMATE_priors.m)
  """

  return _Runtime.call("spm_CLIMATE_priors", *args, **kwargs)
