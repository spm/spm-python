...
def spm_voice_identity(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_voice_identity.m)
  """

  return _Runtime.call("spm_voice_identity", *args, **kwargs)
