...
def spm_fx_adem_pursuit(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_fx_adem_pursuit.m)
  """

  return _Runtime.call("spm_fx_adem_pursuit", *args, **kwargs)
