...
def DEM_demo_Lorenz(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_Lorenz.m)
  """

  return _Runtime.call("DEM_demo_Lorenz", *args, **kwargs, nargout=0)
