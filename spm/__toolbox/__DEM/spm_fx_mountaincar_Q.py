...
def spm_fx_mountaincar_Q(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_fx_mountaincar_Q.m)
  """

  return _Runtime.call("spm_fx_mountaincar_Q", *args, **kwargs)
