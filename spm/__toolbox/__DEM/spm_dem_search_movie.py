...
def spm_dem_search_movie(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_dem_search_movie.m)
  """

  return _Runtime.call("spm_dem_search_movie", *args, **kwargs, nargout=0)
