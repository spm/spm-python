...
def spm_mountaincar_fun(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_mountaincar_fun.m)
  """

  return _Runtime.call("spm_mountaincar_fun", *args, **kwargs)
