...
def DEMO_MDP_voice(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEMO_MDP_voice.m)
  """

  return _Runtime.call("DEMO_MDP_voice", *args, **kwargs)
