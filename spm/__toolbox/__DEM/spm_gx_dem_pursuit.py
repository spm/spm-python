...
def spm_gx_dem_pursuit(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_gx_dem_pursuit.m)
  """

  return _Runtime.call("spm_gx_dem_pursuit", *args, **kwargs)
