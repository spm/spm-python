...
def spm_fx_dem_observe(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_fx_dem_observe.m)
  """

  return _Runtime.call("spm_fx_dem_observe", *args, **kwargs)
