...
def DATA_COVID_JHU(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DATA_COVID_JHU.m)
  """

  return _Runtime.call("DATA_COVID_JHU", *args, **kwargs)
