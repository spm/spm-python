...
def DEM_psychophysics(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_psychophysics.m)
  """

  return _Runtime.call("DEM_psychophysics", *args, **kwargs)
