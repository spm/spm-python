...
def DEM_demo_convolution(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_convolution.m)
  """

  return _Runtime.call("DEM_demo_convolution", *args, **kwargs, nargout=0)
