...
def DEM_COVID_COUNTRY(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_COVID_COUNTRY.m)
  """

  return _Runtime.call("DEM_COVID_COUNTRY", *args, **kwargs)
