...
def DEM_demo_GF_and_KF(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_GF_and_KF.m)
  """

  return _Runtime.call("DEM_demo_GF_and_KF", *args, **kwargs, nargout=0)
