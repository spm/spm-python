...
def spm_voice_P300(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_voice_P300.m)
  """

  return _Runtime.call("spm_voice_P300", *args, **kwargs, nargout=0)
