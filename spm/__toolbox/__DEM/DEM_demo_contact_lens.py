...
def DEM_demo_contact_lens(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_contact_lens.m)
  """

  return _Runtime.call("DEM_demo_contact_lens", *args, **kwargs, nargout=0)
