...
def DEM_COVID_I(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_COVID_I.m)
  """

  return _Runtime.call("DEM_COVID_I", *args, **kwargs, nargout=0)
