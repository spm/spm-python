...
def DEM_demo_song_omission(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_song_omission.m)
  """

  return _Runtime.call("DEM_demo_song_omission", *args, **kwargs, nargout=0)
