...
def DEM_demo_duet(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_duet.m)
  """

  return _Runtime.call("DEM_demo_duet", *args, **kwargs, nargout=0)
