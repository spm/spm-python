...
def spm_voice_get_LEX(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_voice_get_LEX.m)
  """

  return _Runtime.call("spm_voice_get_LEX", *args, **kwargs)
