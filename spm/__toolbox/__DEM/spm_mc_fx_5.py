...
def spm_mc_fx_5(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_mc_fx_5.m)
  """

  return _Runtime.call("spm_mc_fx_5", *args, **kwargs)
