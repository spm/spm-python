...
def DEM_demo_dendrite(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_dendrite.m)
  """

  return _Runtime.call("DEM_demo_dendrite", *args, **kwargs, nargout=0)
