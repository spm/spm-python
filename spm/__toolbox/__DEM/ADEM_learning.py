...
def ADEM_learning(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/ADEM_learning.m)
  """

  return _Runtime.call("ADEM_learning", *args, **kwargs, nargout=0)
