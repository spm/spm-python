...
def spm_MDP_factor_graph(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_MDP_factor_graph.m)
  """

  return _Runtime.call("spm_MDP_factor_graph", *args, **kwargs, nargout=0)
