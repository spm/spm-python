...
def DEM_demo_MDP_habits(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_MDP_habits.m)
  """

  return _Runtime.call("DEM_demo_MDP_habits", *args, **kwargs)
