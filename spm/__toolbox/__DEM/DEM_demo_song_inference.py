...
def DEM_demo_song_inference(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_song_inference.m)
  """

  return _Runtime.call("DEM_demo_song_inference", *args, **kwargs, nargout=0)
