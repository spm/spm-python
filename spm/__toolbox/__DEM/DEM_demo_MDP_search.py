...
def DEM_demo_MDP_search(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_MDP_search.m)
  """

  return _Runtime.call("DEM_demo_MDP_search", *args, **kwargs)
