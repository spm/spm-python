...
def ADEM_cued_response(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/ADEM_cued_response.m)
  """

  return _Runtime.call("ADEM_cued_response", *args, **kwargs, nargout=0)
