...
def spm_gamma_log_evidence(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/spm_gamma_log_evidence.m)
  """

  return _Runtime.call("spm_gamma_log_evidence", *args, **kwargs)
