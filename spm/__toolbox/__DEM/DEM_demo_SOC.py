...
def DEM_demo_SOC(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_SOC.m)
  """

  return _Runtime.call("DEM_demo_SOC", *args, **kwargs, nargout=0)
