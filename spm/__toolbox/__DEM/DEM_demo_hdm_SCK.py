...
def DEM_demo_hdm_SCK(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_demo_hdm_SCK.m)
  """

  return _Runtime.call("DEM_demo_hdm_SCK", *args, **kwargs, nargout=0)
