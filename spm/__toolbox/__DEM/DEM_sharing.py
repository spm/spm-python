...
def DEM_sharing(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DEM/DEM_sharing.m)
  """

  return _Runtime.call("DEM_sharing", *args, **kwargs)
