...
def spm_shoot_template(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Shoot/spm_shoot_template.m)
  """

  return _Runtime.call("spm_shoot_template", *args, **kwargs)
