...
def spm_shoot_kernel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Shoot/spm_shoot_kernel.m)
  """

  return _Runtime.call("spm_shoot_kernel", *args, **kwargs)
