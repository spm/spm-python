...
def spm_shoot_greens(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Shoot/spm_shoot_greens.m)
  """

  return _Runtime.call("spm_shoot_greens", *args, **kwargs)
