...
def spm_dcm_nvc_priors(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/NVC/spm_dcm_nvc_priors.m)
  """

  return _Runtime.call("spm_dcm_nvc_priors", *args, **kwargs)
