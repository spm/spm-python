...
def spm_fx_cmc_tfm_gen(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/NVC/spm_fx_cmc_tfm_gen.m)
  """

  return _Runtime.call("spm_fx_cmc_tfm_gen", *args, **kwargs)
