...
def spm_mci_mfx_dynamic(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/inference/spm_mci_mfx_dynamic.m)
  """

  return _Runtime.call("spm_mci_mfx_dynamic", *args, **kwargs)
