...
def spm_mci_lgv_vl(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/inference/spm_mci_lgv_vl.m)
  """

  return _Runtime.call("spm_mci_lgv_vl", *args, **kwargs)
