...
def spm_mci_switch(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/inference/spm_mci_switch.m)
  """

  return _Runtime.call("spm_mci_switch", *args, **kwargs)
