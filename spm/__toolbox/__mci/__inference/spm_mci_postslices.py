...
def spm_mci_postslices(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/inference/spm_mci_postslices.m)
  """

  return _Runtime.call("spm_mci_postslices", *args, **kwargs)
