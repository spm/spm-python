...
def spm_mci_joint_grad(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/gradients/spm_mci_joint_grad.m)
  """

  return _Runtime.call("spm_mci_joint_grad", *args, **kwargs)
