...
def spm_mci_adjoint_sun(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/gradients/spm_mci_adjoint_sun.m)
  """

  return _Runtime.call("spm_mci_adjoint_sun", *args, **kwargs)
