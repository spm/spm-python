...
def spm_mci_joint(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/gradients/spm_mci_joint.m)
  """

  return _Runtime.call("spm_mci_joint", *args, **kwargs)
