...
def mci_discount_deriv(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/models/discount/mci_discount_deriv.m)
  """

  return _Runtime.call("mci_discount_deriv", *args, **kwargs)
