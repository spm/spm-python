...
def mci_nmm_fx_delay(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/models/nmm/mci_nmm_fx_delay.m)
  """

  return _Runtime.call("mci_nmm_fx_delay", *args, **kwargs)
