...
def mci_exp_init(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/mci/models/lds/mci_exp_init.m)
  """

  return _Runtime.call("mci_exp_init", *args, **kwargs)
