...
def spm_dartel_norm_fun(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DARTEL/spm_dartel_norm_fun.m)
  """

  return _Runtime.call("spm_dartel_norm_fun", *args, **kwargs)
