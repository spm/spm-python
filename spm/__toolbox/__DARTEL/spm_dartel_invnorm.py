...
def spm_dartel_invnorm(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DARTEL/spm_dartel_invnorm.m)
  """

  return _Runtime.call("spm_dartel_invnorm", *args, **kwargs)
