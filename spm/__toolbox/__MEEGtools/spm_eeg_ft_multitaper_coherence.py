...
def spm_eeg_ft_multitaper_coherence(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_eeg_ft_multitaper_coherence.m)
  """

  return _Runtime.call("spm_eeg_ft_multitaper_coherence", *args, **kwargs)
