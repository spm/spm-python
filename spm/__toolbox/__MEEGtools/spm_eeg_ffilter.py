...
def spm_eeg_ffilter(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_eeg_ffilter.m)
  """

  return _Runtime.call("spm_eeg_ffilter", *args, **kwargs)
