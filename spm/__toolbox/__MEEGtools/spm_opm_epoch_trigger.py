...
def spm_opm_epoch_trigger(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_opm_epoch_trigger.m)
  """

  return _Runtime.call("spm_opm_epoch_trigger", *args, **kwargs)
