...
def spm_eeg_fix_ctf_headloc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_eeg_fix_ctf_headloc.m)
  """

  return _Runtime.call("spm_eeg_fix_ctf_headloc", *args, **kwargs)
