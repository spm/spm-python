...
def spm_opm_headmodel(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_opm_headmodel.m)
  """

  return _Runtime.call("spm_opm_headmodel", *args, **kwargs)
