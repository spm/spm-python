...
def spm_opm_create(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_opm_create.m)
  """

  return _Runtime.call("spm_opm_create", *args, **kwargs)
