...
def spm_MEEGtools(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_MEEGtools.m)
  """

  return _Runtime.call("spm_MEEGtools", *args, **kwargs, nargout=0)
