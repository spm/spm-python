...
def spm_eeg_remove_jumps(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/MEEGtools/spm_eeg_remove_jumps.m)
  """

  return _Runtime.call("spm_eeg_remove_jumps", *args, **kwargs)
