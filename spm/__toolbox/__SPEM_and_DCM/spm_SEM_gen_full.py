...
def spm_SEM_gen_full(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/SPEM_and_DCM/spm_SEM_gen_full.m)
  """

  return _Runtime.call("spm_SEM_gen_full", *args, **kwargs)
