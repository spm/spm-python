...
def _bf_reml_sc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/private/bf_reml_sc.m)
  """

  return _Runtime.call("bf_reml_sc", *args, **kwargs)
