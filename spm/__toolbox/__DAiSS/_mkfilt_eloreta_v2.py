...
def _mkfilt_eloreta_v2(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/private/mkfilt_eloreta_v2.m)
  """

  return _Runtime.call("mkfilt_eloreta_v2", *args, **kwargs)
