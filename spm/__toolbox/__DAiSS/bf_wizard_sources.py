...
def bf_wizard_sources(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/bf_wizard_sources.m)
  """

  return _Runtime.call("bf_wizard_sources", *args, **kwargs)
