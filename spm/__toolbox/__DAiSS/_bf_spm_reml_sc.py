...
def _bf_spm_reml_sc(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/private/bf_spm_reml_sc.m)
  """

  return _Runtime.call("spm_reml_sc", *args, **kwargs)
