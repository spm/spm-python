...
def bf_wizard_features(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/bf_wizard_features.m)
  """

  return _Runtime.call("bf_wizard_features", *args, **kwargs)
