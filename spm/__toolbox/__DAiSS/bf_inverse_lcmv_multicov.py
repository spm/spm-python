...
def bf_inverse_lcmv_multicov(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/DAiSS/bf_inverse_lcmv_multicov.m)
  """

  return _Runtime.call("bf_inverse_lcmv_multicov", *args, **kwargs)
