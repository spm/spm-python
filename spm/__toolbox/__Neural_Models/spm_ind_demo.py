...
def spm_ind_demo(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Neural_Models/spm_ind_demo.m)
  """

  return _Runtime.call("spm_ind_demo", *args, **kwargs, nargout=0)
