...
def spm_fx_mfm_ensemble(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Neural_Models/spm_fx_mfm_ensemble.m)
  """

  return _Runtime.call("spm_fx_mfm_ensemble", *args, **kwargs)
