...
def spm_seizure_demo(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Neural_Models/spm_seizure_demo.m)
  """

  return _Runtime.call("spm_seizure_demo", *args, **kwargs, nargout=0)
