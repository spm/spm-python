...
def spm_nested_oscillations_demo(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Neural_Models/spm_nested_oscillations_demo.m)
  """

  return _Runtime.call("spm_nested_oscillations_demo", *args, **kwargs, nargout=0)
