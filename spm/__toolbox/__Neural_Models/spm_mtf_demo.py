...
def spm_mtf_demo(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Neural_Models/spm_mtf_demo.m)
  """

  return _Runtime.call("spm_mtf_demo", *args, **kwargs, nargout=0)
