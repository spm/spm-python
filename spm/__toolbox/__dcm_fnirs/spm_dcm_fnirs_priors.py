...
def spm_dcm_fnirs_priors(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_fnirs/spm_dcm_fnirs_priors.m)
  """

  return _Runtime.call("spm_dcm_fnirs_priors", *args, **kwargs)
