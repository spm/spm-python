...
def spm_gx_state_fnirs(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_fnirs/spm_gx_state_fnirs.m)
  """

  return _Runtime.call("spm_gx_state_fnirs", *args, **kwargs)
