...
def spm_fnirs_sensitivity(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_fnirs/spm_fnirs_sensitivity.m)
  """

  return _Runtime.call("spm_fnirs_sensitivity", *args, **kwargs)
