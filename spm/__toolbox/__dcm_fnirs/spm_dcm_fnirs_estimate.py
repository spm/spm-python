...
def spm_dcm_fnirs_estimate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_fnirs/spm_dcm_fnirs_estimate.m)
  """

  return _Runtime.call("spm_dcm_fnirs_estimate", *args, **kwargs)
