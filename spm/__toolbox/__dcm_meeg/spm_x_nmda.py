...
def spm_x_nmda(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_x_nmda.m)
  """

  return _Runtime.call("spm_x_nmda", *args, **kwargs)
