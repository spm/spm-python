...
def spm_dcm_search_eeg(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_dcm_search_eeg.m)
  """

  return _Runtime.call("spm_dcm_search_eeg", *args, **kwargs)
