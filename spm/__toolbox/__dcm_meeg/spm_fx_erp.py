...
def spm_fx_erp(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_fx_erp.m)
  """

  return _Runtime.call("spm_fx_erp", *args, **kwargs)
