...
def spm_dcm_tfm_multimodal(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_dcm_tfm_multimodal.m)
  """

  return _Runtime.call("spm_dcm_tfm_multimodal", *args, **kwargs)
