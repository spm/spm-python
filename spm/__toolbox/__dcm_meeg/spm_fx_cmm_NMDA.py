...
def spm_fx_cmm_NMDA(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_fx_cmm_NMDA.m)
  """

  return _Runtime.call("spm_fx_cmm_NMDA", *args, **kwargs)
