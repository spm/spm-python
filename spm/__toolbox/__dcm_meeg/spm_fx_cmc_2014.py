...
def spm_fx_cmc_2014(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_fx_cmc_2014.m)
  """

  return _Runtime.call("spm_fx_cmc_2014", *args, **kwargs)
