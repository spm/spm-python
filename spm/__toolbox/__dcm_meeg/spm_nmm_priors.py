...
def spm_nmm_priors(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_nmm_priors.m)
  """

  return _Runtime.call("spm_nmm_priors", *args, **kwargs)
