...
def spm_eeg_inv_ecd_DrawDip(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_eeg_inv_ecd_DrawDip.m)
  """

  return _Runtime.call("spm_eeg_inv_ecd_DrawDip", *args, **kwargs, nargout=0)
