...
def spm_dcm_virtual_electrodes(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_dcm_virtual_electrodes.m)
  """

  return _Runtime.call("spm_dcm_virtual_electrodes", *args, **kwargs)
