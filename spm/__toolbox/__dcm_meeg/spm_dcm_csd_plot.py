...
def spm_dcm_csd_plot(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/dcm_meeg/spm_dcm_csd_plot.m)
  """

  return _Runtime.call("spm_dcm_csd_plot", *args, **kwargs, nargout=0)
