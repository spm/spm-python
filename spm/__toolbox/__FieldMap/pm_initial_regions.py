...
def pm_initial_regions(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/FieldMap/pm_initial_regions.m)
  """

  return _Runtime.call("pm_initial_regions", *args, **kwargs)
