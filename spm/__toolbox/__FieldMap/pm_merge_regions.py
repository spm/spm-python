...
def pm_merge_regions(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/FieldMap/pm_merge_regions.m)
  """

  return _Runtime.call("pm_merge_regions", *args, **kwargs)
