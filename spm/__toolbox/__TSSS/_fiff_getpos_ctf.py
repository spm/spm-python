...
def _fiff_getpos_ctf(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/TSSS/private/fiff_getpos_ctf.m)
  """

  return _Runtime.call("fiff_getpos_ctf", *args, **kwargs)
