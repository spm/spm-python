...
def tsss_spm_momentspace(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/TSSS/tsss_spm_momentspace.m)
  """

  return _Runtime.call("tsss_spm_momentspace", *args, **kwargs)
