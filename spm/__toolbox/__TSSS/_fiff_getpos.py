...
def _fiff_getpos(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/TSSS/private/fiff_getpos.m)
  """

  return _Runtime.call("fiff_getpos", *args, **kwargs)
