...
def spm_slice2vol_estimate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Spatial/spm_slice2vol_estimate.m)
  """

  return _Runtime.call("spm_slice2vol_estimate", *args, **kwargs)
