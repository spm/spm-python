...
def spm_get_orig_coord(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/OldNorm/spm_get_orig_coord.m)
  """

  return _Runtime.call("spm_get_orig_coord", *args, **kwargs)
