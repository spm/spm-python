...
def spm_brainwarp(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/OldNorm/spm_brainwarp.m)
  """

  return _Runtime.call("spm_brainwarp", *args, **kwargs)
