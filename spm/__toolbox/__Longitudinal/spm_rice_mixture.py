...
def spm_rice_mixture(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Longitudinal/spm_rice_mixture.m)
  """

  return _Runtime.call("spm_rice_mixture", *args, **kwargs)
