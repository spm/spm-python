...
def spm_noise_estimate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/toolbox/Longitudinal/spm_noise_estimate.m)
  """

  return _Runtime.call("spm_noise_estimate", *args, **kwargs)
