...
def spm_eeg_specest_mtmfft(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_specest_mtmfft.m)
  """

  return _Runtime.call("spm_eeg_specest_mtmfft", *args, **kwargs)
