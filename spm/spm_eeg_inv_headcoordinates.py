...
def spm_eeg_inv_headcoordinates(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_inv_headcoordinates.m)
  """

  return _Runtime.call("spm_eeg_inv_headcoordinates", *args, **kwargs)
