...
def spm_eeg_artefact_nans(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_artefact_nans.m)
  """

  return _Runtime.call("spm_eeg_artefact_nans", *args, **kwargs)
