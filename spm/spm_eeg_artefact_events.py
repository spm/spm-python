...
def spm_eeg_artefact_events(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_artefact_events.m)
  """

  return _Runtime.call("spm_eeg_artefact_events", *args, **kwargs)
