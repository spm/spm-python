...
def spm_dcm_connectivity_ui(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_dcm_connectivity_ui.m)
  """

  return _Runtime.call("spm_dcm_connectivity_ui", *args, **kwargs)
