...
def spm_timeseries_resample(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_timeseries_resample.m)
  """

  return _Runtime.call("spm_timeseries_resample", *args, **kwargs)
