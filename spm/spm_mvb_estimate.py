...
def spm_mvb_estimate(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_mvb_estimate.m)
  """

  return _Runtime.call("spm_mvb_estimate", *args, **kwargs)
