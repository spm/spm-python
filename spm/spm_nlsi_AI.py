...
def spm_nlsi_AI(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_nlsi_AI.m)
  """

  return _Runtime.call("spm_nlsi_AI", *args, **kwargs)
