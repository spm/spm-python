...
def spm_eeg_correct_sensor_data(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_eeg_correct_sensor_data.m)
  """

  return _Runtime.call("spm_eeg_correct_sensor_data", *args, **kwargs)
