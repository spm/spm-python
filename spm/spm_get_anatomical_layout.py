...
def spm_get_anatomical_layout(*args, **kwargs):
  ...
  [Link to the Matlab implementation.](https://github.com/spm/spm/blob/main/spm_get_anatomical_layout.m)
  """

  return _Runtime.call("spm_get_anatomical_layout", *args, **kwargs)
